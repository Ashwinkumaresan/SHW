...
class UserProfileModel(models.Model):
    ...
    Guadian1=models.CharField(max_length=10,null=True,blank=True)
    Guadian2=models.CharField(max_length=10,null=True,blank=True)
    Guadian3=models.CharField(max_length=10,null=True,blank=True)
    User=models.ForeignKey(User,on_delete=models.CASCADE)
