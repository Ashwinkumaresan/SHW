            ...
            <div className="login">
                <div className="row">
                    <div className="col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6 text-center pt-5">
                        ...
                        <h2 className='text-center playwritter fs-2 p-0 m-1 fw-bolder mb-4'>Connet with doctors</h2>
                        <h2>Doctor Login</h2>
                        <form onSubmit={handleSubmit}>
                            <div className="pt-1 ps-5 pe-5 d-flex flex-column align-items-center">   
                                {
                                    invalid && 
